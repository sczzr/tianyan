...
namespace TianYanShop.World.Config
{
    ...
    public static class RealmTransitionConfig
    {
        ...
        /// </summary>
        public static RealmType GetRealmFromSpirit(Data.SpiritLevel spirit)
        {
            return spirit switch
            {
                Data.SpiritLevel.Desolate => RealmType.Desolate,
                Data.SpiritLevel.Barren => RealmType.Barren,
                Data.SpiritLevel.Sparse => RealmType.Sparse,
                Data.SpiritLevel.Normal => RealmType.Normal,
                Data.SpiritLevel.Rich => RealmType.Rich,
                Data.SpiritLevel.Abundant => RealmType.Abundant,
                Data.SpiritLevel.Extreme => RealmType.Abundant,
                _ => RealmType.Normal
            };
        }
