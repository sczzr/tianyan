    ...
    public partial class RealmMapManager : Node2D
    {
        ...
        private void SetupLayerManager()
        {
            ...
            if (_layerManager == null)
            {
                ...
                GD.Print("[RealmMapManager] 已创建 MapLayerManager");
            }
            else
            {
                GD.Print("[RealmMapManager] 已找到 MapLayerManager");
            }
        }
        ...
        private void SetupTileMap()
        {
            ...
            foreach (var kvp in RealmTransitionConfig.Terrains)
            {
        ...
        private void UpdateLayerData()
        {
            if (_layerManager != null)
            {
                _layerManager.UpdateMapData(_generator.MapTiles, TileSize);
                GD.Print("[RealmMapManager] 已更新图层数据");
            }
        }
        ...
        public Data.RealmTile GetTileAt(int x, int y)
        {
            return _generator.GetTile(x, y);
        }

        public Data.RealmTile GetTileAtWorldPosition(Vector2 worldPos)
        {
