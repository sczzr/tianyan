...
public class HeightmapTemplate
{
	...
	public HeightmapTemplate(string name, string template, int probability)
	{
		Name = name;
		Template = template;
...
{
	public static readonly Dictionary<HeightmapTemplateType, HeightmapTemplate> Templates = new()
	{
		{
			HeightmapTemplateType.Volcano,
			new HeightmapTemplate("Volcano", @"
...
Mask 3 0 0 0", 3)
		...
		{
			HeightmapTemplateType.HighIsland,
			new HeightmapTemplate("High Island", @"
...
Pit 3-5 10-30 15-85 20-80", 19)
		},
		{
			HeightmapTemplateType.LowIsland,
			new HeightmapTemplate("Low Island", @"
...
Mask 4 0 0 0", 9)
		...
		{
			HeightmapTemplateType.Continents,
			new HeightmapTemplate("Continents", @"
...
Mask 4 0 0 0", 16)
		...
		{
			HeightmapTemplateType.Archipelago,
			new HeightmapTemplate("Archipelago", @"
Add 11 all 0 0
...
Strait 2 vertical 0 0
Strait 2 horizontal 0 0", 18)
		},
		{
			HeightmapTemplateType.Atoll,
			new HeightmapTemplate("Atoll", @"
Hill 1 75-80 50-60 45-55
Hill 1.5 30-50 25-75 30-70
Hill 0.5 30-50 25-35 30-70
Smooth 1 0 0 0
Multiply 0.2 25-100 0 0
Hill 0.5 10-20 50-55 48-52", 1)
		},
		{
			HeightmapTemplateType.Mediterranean,
			new HeightmapTemplate("Mediterranean", @"
...
Trough 3-6 40-50 0-100 90-100", 5)
		},
		{
			HeightmapTemplateType.Peninsula,
			new HeightmapTemplate("Peninsula", @"
...
Smooth 3 0 0 0
Invert 0.4 both 0 0", 3)
		},
		{
			HeightmapTemplateType.Pangea,
			new HeightmapTemplate("Pangea", @"
...
Range 5-6 30-40 10-90 35-65", 5)
		},
		{
			HeightmapTemplateType.Isthmus,
			new HeightmapTemplate("Isthmus", @"
...
Invert 0.25 x 0 0", 2)
		...
		{
			HeightmapTemplateType.Shattered,
			new HeightmapTemplate("Shattered", @"
Hill 8 35-40 15-85 30-70
Trough 10-20 40-50 5-95 5-95
Range 5-7 30-40 10-90 20-80
Pit 12-20 30-40 15-85 20-80", 7)
		},
		{
			HeightmapTemplateType.Taklamakan,
			new HeightmapTemplate("Taklamakan", @"
...
Smooth 3 0 0 0", 1)
		...
		{
			HeightmapTemplateType.OldWorld,
			new HeightmapTemplate("Old World", @"
...
Pit 5-6 20-30 10-90 10-90", 8)
		},
		{
			HeightmapTemplateType.Fractious,
			new HeightmapTemplate("Fractious", @"
Hill 12-15 50-80 5-95 5-95
Mask -1.5 0 0 0
Mask 3 0 0 0
Add -20 30-100 0 0
Range 6-8 40-50 5-95 10-90", 3)
		}
	};
	...
	/// 根据权重随机选择一个模板
	/// </summary>
	public static HeightmapTemplateType GetRandomTemplate(Random random)
	{
		int totalWeight = 0;
		foreach (var template in Templates.Values)
		{
			totalWeight += template.Probability;
		}
	...
	/// 获取模板内容
	/// </summary>
	public static string GetTemplate(HeightmapTemplateType type)
	{
		return Templates.TryGetValue(type, out var template) ? template.Template : string.Empty;
	}

	/// <summary>
	/// 获取模板名称
	/// </summary>
	public static string GetTemplateName(HeightmapTemplateType type)
	{
		return Templates.TryGetValue(type, out var template) ? template.Name : "Unknown";
	}
}
