...
public partial class MainMenu : Control
{
	...
	{
		MapGeneratorUI.PrepareNewGameEntry();
		SwitchToScene("res://Scenes/MapGenerator/MapGeneratorUI.tscn");
	}

	private void OnLoadGamePressed()
	{
		SwitchToScene("res://Scenes/Screens/LoadGame.tscn");
	}

	private void OnModManagerPressed()
	{
		SwitchToScene("res://Scenes/Screens/ModManager.tscn");
	}
